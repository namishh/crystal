...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/alpha-nvim",
  ...
  ["gitsigns.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/gitsigns.nvim",
  ...
  ["indent-blankline.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim",
    url = "https://github.com/lukas-reineke/indent-blankline.nvim"
  },
  ["mason.nvim"] = {
    commands = { "MasonInstall", "MasonUninstall", "Mason", "MasonUninstallAll", "MasonLog" },
    config = { "require('plugins.lsp.mason')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/mason.nvim",
  ...
  ["nvim-comment"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/nvim-comment",
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-treesitter"] = {
    ...
    commands = { 'require("plugins.commands").treesitter' },
  ...
  ["nvim-web-devicons"] = {
    config = { "require('plugins.ui.devicons')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
    url = "https://github.com/kyazdani42/nvim-web-devicons"
  },
  ["packer.nvim"] = {
    commands = { 'require("plugins.commands").packer' },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/packer.nvim",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ["toggleterm.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/toggleterm.nvim",
  ...
  ["vim-startuptime"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/namish/.local/share/nvim/site/pack/packer/opt/vim-startuptime",
...
pcall(vim.api.nvim_create_user_command, 'Alpha', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'alpha-nvim'}, { cmd = 'Alpha' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'AlphaRedraw', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'alpha-nvim'}, { cmd = 'AlphaRedraw' }, _G.packer_plugins)
...
pcall(vim.cmd, [[au CmdUndefined require("plugins.commands").treesitter ++once lua require"packer.load"({'nvim-treesitter'}, {}, _G.packer_plugins)]])
...
pcall(vim.cmd, [[au CmdUndefined require("plugins.commands").packer ++once lua require"packer.load"({'packer.nvim'}, {}, _G.packer_plugins)]])
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'alpha-nvim', 'plenary.nvim', 'nvim-web-devicons', 'indent-blankline.nvim', 'toggleterm.nvim', 'gitsigns.nvim', 'nvim-comment'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-ts-autotag', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
time([[Defining lazy-load event autocommands]], false)
vim.cmd("augroup END")
vim.cmd [[augroup filetypedetect]]
time([[Sourcing ftdetect script at: /home/namish/.local/share/nvim/site/pack/packer/opt/yuck.vim/ftdetect/yuck.vim]], true)
vim.cmd [[source /home/namish/.local/share/nvim/site/pack/packer/opt/yuck.vim/ftdetect/yuck.vim]]
time([[Sourcing ftdetect script at: /home/namish/.local/share/nvim/site/pack/packer/opt/yuck.vim/ftdetect/yuck.vim]], false)
vim.cmd("augroup END")
