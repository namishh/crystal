...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'plenary.nvim', 'alpha-nvim', 'gitsigns.nvim', 'nvim-comment', 'indent-blankline.nvim', 'toggleterm.nvim', 'nvim-web-devicons'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
