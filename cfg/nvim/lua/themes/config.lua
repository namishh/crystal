...
M.highlights_base = function(colors)
  return {
    ...
    PmenuSel = { fg = colors.bgfixed, bg = colors.color4 },
    ...
    StalineNormalMode = { bg = colors.color12, fg = colors.bgfixed },
    StalineVisualMode = { bg = colors.color11, fg = colors.bgfixed },
    StalineCommandMode = { bg = colors.color9, fg = colors.bgfixed },
    StalineInsertMode = { bg = colors.color10, fg = colors.bgfixed },
    StalineTerminalMode = { bg = colors.color13, fg = colors.bgfixed },
    StalineNTerminalMode = { bg = colors.color13, fg = colors.bgfixed },
    StalineConfirmMode = { bg = colors.color6, fg = colors.bgfixed },
    ...
    StalineLspError = { bg = colors.bgfixed, fg = colors.color9 },
    StalineLspInfo = { bg = colors.bgfixed, fg = colors.color12 },
    StalineLspHints = { bg = colors.bgfixed, fg = colors.color6 },
    StalineLspWarning = { bg = colors.bgfixed, fg = colors.color11 },
    StalineLspErrorIcon = { bg = colors.bgfixed, fg = colors.color9 },
    StalineLspInfoIcon = { bg = colors.bgfixed, fg = colors.color12 },
    StalineLspHintsIcon = { bg = colors.bgfixed, fg = colors.color6 },
    StalineLspWarningIcon = { bg = colors.bgfixed, fg = colors.color11 },
    StalineLspName = { bg = colors.color8, fg = colors.foreground },
    StalineLspIcon = { bg = colors.color13, fg = colors.bgfixed },
