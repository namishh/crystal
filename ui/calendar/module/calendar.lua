...
local datewidget = function(date, weekend, notIn)
  ...
  if notIn then
    ...
    return wibox.widget {
      markup = weekend and helpers.colorizeText(date, beautiful.fg2) or helpers.colorizeText(date, beautiful.fg2),
      halign = 'center',
      font   = beautiful.sans .. " 14",
      widget = wibox.widget.textbox
    }
...
local daywidget = function(day, weekend, notIn)
  weekend = weekend or false
  return wibox.widget {
    markup = weekend and helpers.colorizeText(day, beautiful.comm) or helpers.colorizeText(day, beautiful.comm),
    halign = 'center',
...
local currwidget = function(day)
  return wibox.widget {
    {
      markup = helpers.colorizeText(day, beautiful.fg),
      halign = 'center',
      font   = beautiful.sans .. " 12",
      widget = wibox.widget.textbox,
    },
