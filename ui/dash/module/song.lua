        ...
        {
          {
            ...
            markup = helpers.colorizeText('Now Playing', beautiful.comm),
            widget = wibox.widget.textbox,
          },
          {
            id = "songname",
          ...
          },
          {
            ...
            markup = helpers.colorizeText('Artist Name', beautiful.comm),
            widget = wibox.widget.textbox,
          },
          spacing = 4,
...
playerctl:connect_signal("metadata", function(_, title, artist, album_path, album, new, player_name)
  ...
  art.image = helpers.cropSurface(2.6, gears.surface.load_uncached(album_path))
  helpers.gc(widget, "songname"):set_markup_silently(helpers.colorizeText(title or "NO", beautiful.fg))
  helpers.gc(widget, "artist"):set_markup_silently(helpers.colorizeText(artist or "HM", beautiful.comm))
end)
return widget
